...
/**
 * Entité représentant une mission sous-marine avec priorité et invariants stricts.
 */
public class Mission {
    ...
    public void assign() {
        if (!isPending()) {
            throw new IllegalStateException("Seule une mission en attente peut être affectée.");
        }
    ...
    public void complete() {
        if (status != MissionStatus.ASSIGNED) {
            throw new IllegalStateException("Seule une mission affectée peut être terminée.");
        }
